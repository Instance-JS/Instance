/// SPDX-License-Identifier: AGPL-3.0 (Satoshi) 
// [AGPL license only applies to governance forks of this model]. You are free to join the DAO while keeping your code closed source internally,
// as long as it's not Instance.js without an accompanying license. As the DAO by definition is not an 'internal model'. 
// However, future governance models modeled after this one must remain transparently open source. There is no hybrid licensing model.
