...
| `<ol>`   | `OL`          | Ordered List                         | Rule 1: Ties to 'Ordered List'; Rule 2: *generally* enunciated as 'O-L'. Hierarchic invariant Rule 1 overrides subjective interpreations of Rule 2.      |
