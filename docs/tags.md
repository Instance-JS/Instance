...
| `<wbr>`  | `WBR`         | Word Break Opportunity               | Rule 1: subjective. (Word Break (Rule / Opportunity)). Application of Rule 2 is non-subjective: 'W-B-R'. Overrides subjective Rule 1. |
