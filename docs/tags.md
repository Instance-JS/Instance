...
|-----------|----------------|---------------------------------------|---------------------------------------------------------------------------|
| `<li>`   | `LI`          | List Item                            | Rule 1: Directly ties to formal spec name 'List Item'; Rule 2: *sometimes* pronounced 'L-I' instead of `Li`. Hierarchic invariant 'Rule 1' overrides subjective interpretations of Rule 2. |
| `<ul>`   | `UL`          | Unordered List                       | Rule 1: Ties to 'Unordered List'; Rule 2: *generally* enunciated as 'U-L'. Hierarchic invariant Rule 1 overrides subjective interpretations of Rule 2.       |
| `<ol>`   | `OL`          | Ordered List                         | Rule 1: Ties to 'Ordered List'; Rule 2: *generally* enunciated as 'O-L'. Hierarchic invariant Rule 1 overrides subjective interpreationss of Rule 2.      |
